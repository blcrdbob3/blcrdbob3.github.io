...
/** @type {string} */
const CACHE_VERSION = '1743262074|1925973623';
/** @type {string} */
const CACHE_PREFIX = 'Chess-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Chess.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Chess.html","Chess.js","Chess.offline.html","Chess.icon.png","Chess.apple-touch-icon.png","Chess.audio.worklet.js","Chess.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Chess.wasm","Chess.pck","Chess.side.wasm"];
